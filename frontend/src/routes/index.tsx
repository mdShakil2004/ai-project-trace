  ...
  return <AppShell>
    <div className="border-b border-border px-4 py-6 md:px-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div><h1 className="text-xl font-semibold tracking-tight">Good afternoon, Shakil</h1><p className="mt-1 text-sm text-muted-foreground">Understand what changed before you approve it.</p></div>
