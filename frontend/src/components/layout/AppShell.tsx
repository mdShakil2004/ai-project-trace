...
import { Bell, ChevronDown, FolderGit2, Github, LayoutDashboard, Menu, Search, Settings, Sparkles, Telescope } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/analyze', label: 'Investigate PR', icon: Sparkles },
